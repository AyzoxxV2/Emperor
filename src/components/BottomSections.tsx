    ...
    <>
      ...
      <section className="testimonials" ref={testiRef}>
        <div className="testimonials__container">
          ...
          >
            ...
            <h2 className="display-lg">{SITE_CONFIG.testimonials.title}<br /><span className="gold-text">{SITE_CONFIG.testimonials.titleGold}</span></h2>
          </motion.div>
        ...
        <div className="efaq-section__container">
          <div className="efaq-section__layout">
            ...
            >
              ...
              <a href={SITE_CONFIG.links.discord} target="_blank" rel="noopener noreferrer" className="btn btn--gold efaq-section__discord">
                <Users size={15} /> Join Discord
              </a>
              <img src={SITE_CONFIG.brand.faqBannerImg} alt="FAQ" className="efaq-section__banner" />
            </motion.div>
      ...
      <section className="ecta-banner">
        <div className="ecta-banner__inner">
          ...
          >
            <div className="badge badge--gold">{SITE_CONFIG.ctaBanner.badge}</div>
            ...
            <div className="ecta-banner__ctas">
              ...
              <a href={SITE_CONFIG.links.discord} target="_blank" rel="noopener noreferrer" className="btn btn--outline ecta-banner__btn">
                <Users size={15} /> Join Discord
              </a>
            </div>
          </motion.div>
        ...
        <div className="efooter__top">
          <div className="efooter__brand-col">
            <div className="efooter__brand">
              <img src={SITE_CONFIG.brand.logoGif} alt="Emperor" className="efooter__avatar" />
              <div>
                <div className="efooter__name">EMPEROR</div>
                <div className="efooter__sub">{SITE_CONFIG.brand.tagline} — Est. {SITE_CONFIG.brand.foundedYear}</div>
              </div>
            </div>
            ...
            <div className="efooter__socials">
              <a href={SITE_CONFIG.links.discord} target="_blank" rel="noopener noreferrer" className="efooter__social efooter__social--discord">
          ...
          <div className="efooter__links-cols">
            <div className="efooter__links-col">
              ...
              <button className="efooter__link">Changelog</button>
              <button className="efooter__link">Roadmap</button>
            </div>
            <div className="efooter__links-col">
              <div className="efooter__links-title">Support</div>
              <a href="/support" className="efooter__link">Help Center</a>
              <a href={SITE_CONFIG.links.discord} target="_blank" rel="noopener noreferrer" className="efooter__link">
                Discord <ExternalLink size={10} />
              </a>
              <a href={`mailto:${SITE_CONFIG.links.supportEmail}`} className="efooter__link">Email Us</a>
              <button className="efooter__link">Status</button>
              <button className="efooter__link">Report a Bug</button>
            </div>
            <div className="efooter__links-col">
              <div className="efooter__links-title">Legal</div>
              <button className="efooter__link">Terms of Service</button>
              <button className="efooter__link">Privacy Policy</button>
              <button className="efooter__link">Cookie Policy</button>
              <button className="efooter__link">Refund Policy</button>
            </div>
          </div>
        </div>

        <div className="efooter__bottom">
          <div className="efooter__copy">{SITE_CONFIG.brand.copyright}</div>
